...
const translations = {
    th: {
        ...
        noKnowledgeYet: 'ยังไม่มีข้อมูลความรู้',
        noSearchResults: 'ไม่พบผลลัพธ์ ลองค้นหาด้วยคำค้นอื่นหรือเปลี่ยนตัวกรอง',
        ...
        approveTooltip: 'อนุมัติ',
        rejectTooltip: 'ปฏิเสธ',
        expired: 'หมดอายุ',
        loadingKnowledge: 'กำลังโหลดข้อมูล...',
        ...
        websiteUrlLabel: 'ลิงก์เว็บไซต์ หรือ Google Drive',
        urlInputPlaceholder: 'https://example.com หรือ https://docs.google.com/spreadsheets/d/...',
        urlExtractionHint: 'รองรับเว็บไซต์ทั่วไป, Google Sheets, Google Docs, Google Slides (ต้องตั้งเป็น "ทุกคนที่มีลิงก์สามารถดู")',
        ...
        // Tool Access
        toolAccessTitle: 'จัดการ AI Agent Tools',
        toolAccessSubtitle: 'จัดการสิทธิ์การเข้าถึง AI Agent Tools ตาม Role',
        toolEnabled: 'เปิดใช้งาน',
        toolNoTools: 'ไม่พบ Tools',
        toolNoToolsDesc: 'ยังไม่มี tools ที่โหลดในระบบ กรุณาตรวจสอบ backend',
        toolLoading: 'กำลังโหลด...',
        toolRetry: 'ลองใหม่',
        toolSave: 'บันทึก',
        toolReset: 'รีเซ็ต',
        toolAllowedRoles: 'สิทธิ์ตาม Role',
        toolFetchError: 'ไม่สามารถโหลดข้อมูล tools ได้',
        toolSaveSuccess: 'บันทึก {name} สำเร็จ',
        toolSaveFailed: 'บันทึก {name} ไม่สำเร็จ',
        toolResetConfirm: 'รีเซ็ต "{name}" เป็นค่าเริ่มต้นจาก code?',
        toolResetSuccess: 'รีเซ็ต {name} สำเร็จ',
        toolResetFailed: 'รีเซ็ต {name} ไม่สำเร็จ',
        roleAll: 'ทุกคน (All)',

        // System Prompts
        promptsTitle: 'พรอมต์ระบบ',
        promptsSubtitle: 'จัดการคำสั่งควบคุมบุคลิกและพฤติกรรม AI',
        promptAvailable: 'พรอมต์ที่ใช้ได้',
        promptNoPrompts: 'ไม่พบพรอมต์',
        promptNoDesc: 'ไม่มีคำอธิบาย',
        promptSelect: 'เลือกพรอมต์เพื่อดูหรือแก้ไข',
        promptReadOnly: 'อ่านอย่างเดียว',
        promptReset: 'รีเซ็ต',
        promptSaveChanges: 'บันทึกการเปลี่ยนแปลง',
        promptSaving: 'กำลังบันทึก...',
        promptUnsaved: 'มีการแก้ไขที่ยังไม่บันทึก',
        promptCreateNew: 'สร้างพรอมต์ใหม่',
        promptKeyLabel: 'คีย์พรอมต์',
        promptDescLabel: 'คำอธิบาย',
        promptInitContent: 'เนื้อหาเริ่มต้น',
        promptCreating: 'กำลังสร้าง...',
        promptCreateBtn: 'สร้างพรอมต์',
        promptDiscardChanges: 'คุณมีการแก้ไขที่ยังไม่บันทึก ต้องการยกเลิกหรือไม่?',

        // Users
        usersTitle: 'ผู้ใช้งาน',
        usersSubtitle: 'จัดการบัญชีผู้ใช้ทั้งหมดและสิทธิ์การเข้าถึง',
        createUser: 'สร้างผู้ใช้',
        editUser: 'แก้ไขผู้ใช้',
        deleteUser: 'ลบผู้ใช้',
        deleteUserConfirm: 'คุณแน่ใจว่าต้องการลบผู้ใช้นี้? การดำเนินการนี้ไม่สามารถย้อนกลับได้',
        username: 'ชื่อผู้ใช้',
        password: 'รหัสผ่าน',
        firstName: 'ชื่อ',
        lastName: 'นามสกุล',
    ...
    en: {
        ...
        renameKnowledge: 'Rename',
        publishSuccess: 'Published successfully',
        publishRequestSent: 'Publish request sent. Awaiting admin approval.',
        publishFailed: 'Publish failed',
        processingStatus: 'Processing...',
        noKnowledgeFound: 'No knowledge found.',
        noKnowledgeYet: 'No knowledge yet.',
        noSearchResults: 'No results found. Try a different search term or filter.',
        ...
        websiteUrlLabel: 'Website URL or Google Drive link',
        urlInputPlaceholder: 'https://example.com or https://docs.google.com/spreadsheets/d/...',
        urlExtractionHint: 'Supports websites, Google Sheets, Google Docs, and Google Slides. Google Drive files must be set to "Anyone with the link can view".',
        ...
        toolAccessSubtitle: 'Manage AI Agent Tool access by role',
        toolEnabled: 'enabled',
        toolNoTools: 'No Tools Found',
        toolNoToolsDesc: 'No tools loaded in the system. Check backend configuration.',
        toolLoading: 'Loading...',
        toolRetry: 'Retry',
        toolSave: 'Save',
        toolReset: 'Reset',
        toolAllowedRoles: 'Allowed Roles',
        toolFetchError: 'Failed to load tools data',
        toolSaveSuccess: 'Saved {name} successfully',
        toolSaveFailed: 'Failed to save {name}',
        toolResetConfirm: 'Reset "{name}" to code defaults?',
        toolResetSuccess: 'Reset {name} successfully',
        toolResetFailed: 'Failed to reset {name}',
        roleAll: 'Everyone (All)',

        // System Prompts
        promptsTitle: 'System Prompts',
        promptsSubtitle: 'Manage AI personality and behavior instructions.',
        promptAvailable: 'Available Prompts',
        promptNoPrompts: 'No prompts found.',
        promptNoDesc: 'No description',
        promptSelect: 'Select a system prompt to view or edit',
        promptReadOnly: 'Read Only',
        promptReset: 'Reset',
        promptSaveChanges: 'Save Changes',
        promptSaving: 'Saving...',
        promptUnsaved: 'Unsaved Changes',
        promptCreateNew: 'Create New Prompt',
        promptKeyLabel: 'Prompt Key',
        promptDescLabel: 'Description',
        promptInitContent: 'Initial Content',
        promptCreating: 'Creating...',
        promptCreateBtn: 'Create Prompt',
        promptDiscardChanges: 'You have unsaved changes. Discard them?',

        // Users
        usersTitle: 'Users',
        usersSubtitle: 'Manage all user accounts and roles.',
