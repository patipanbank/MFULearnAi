...
<template>
  <Teleport to="body">
    ...
    <!-- Admin Tools (Superadmin Only) -->
        <nav v-if="authStore.user?.role === 'superadmin'" class="nav-links mt-4">
          <div class="section-label">Admin Tools</div>
          
          <button class="nav-btn" :class="{ 'active': route.path === '/dashboard' }" @click="navigateTo('/dashboard')">
              <div class="icon-box">
          ...
          <button class="nav-btn" :class="{ 'active': route.path === '/dashboard/users' }" @click="navigateTo('/dashboard/users')">
              <div class="icon-box">
          ...
          <button class="nav-btn" :class="{ 'active': route.path === '/dashboard/departments' }" @click="navigateTo('/dashboard/departments')">
              <div class="icon-box">
          ...
          <button class="nav-btn" :class="{ 'active': route.path === '/dashboard/prompts' }" @click="navigateTo('/dashboard/prompts')">
              <div class="icon-box">
