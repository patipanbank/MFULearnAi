...
<template>
  ...
  >
    ...
    <div class="sidebar-nav">
        ...
        <router-link 
            v-if="['admin', 'superadmin'].includes(authStore.user?.role)"
            to="/admin/prompts" 
            class="nav-item" 
            active-class="active"
        >
            ...
            <span v-if="!isEffectiveCollapsed">Admin Prompts</span>
        </router-link>
        <router-link 
            v-if="['admin', 'superadmin'].includes(authStore.user?.role)"
        ...
        >
            ...
            <span v-if="!isEffectiveCollapsed">Departments</span>
        </router-link>
        <router-link 
            v-if="['admin', 'superadmin'].includes(authStore.user?.role)"
            to="/admin/users" 
        ...
        >
            ...
            <span v-if="!isEffectiveCollapsed">Admins</span>
        </router-link>
    </div>
