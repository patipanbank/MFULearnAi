      ...
      <div className="flex-1 flex flex-col max-w-none">
        ...
        <div className="flex-1 overflow-y-auto px-4 md:px-16 lg:px-32 xl:px-48 py-4 pb-32 space-y-2">
          {currentSession?.messages.map((msg) => (
            <div
              key={msg.id}
              className={`flex ${msg.role === 'user' ? 'justify-end pr-2 md:pr-8 lg:pr-16 xl:pr-48 2xl:pr-64' : 'justify-start pl-2 md:pl-8 lg:pl-16 xl:pl-48 2xl:pl-64'}`}
            >
              {msg.role !== 'user' && (
              ...
              <div className="flex flex-col">
                ...
                <div
                  className={`max-w-2xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-2xl 2xl:max-w-3xl w-fit px-3 py-2 rounded-lg ${
                    msg.role === 'user'
