            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 pb-32 space-y-4">
                    ...
                    <div
                      className={`max-w-xl w-fit px-4 py-3 rounded-2xl ${
                        msg.role === 'user'
                          ...
                          : 'bg-white dark:bg-gradient-to-br dark:from-gray-800/90 dark:via-gray-800/80 dark:to-gray-800/70 backdrop-blur-sm text-gray-800 dark:text-white mr-4 shadow-sm hover:shadow-md dark:shadow-lg dark:hover:shadow-xl transition-all duration-300 ease-in-out dark:border dark:border-gray-700/30 dark:hover:border-gray-600/40'
                      }`}
                    >
                      {/* Images */}
              ...
              {isTyping && (
                <div className="flex justify-start max-w-3xl mx-auto">
                  <div className="flex items-center space-x-3 bg-white dark:bg-gradient-to-br dark:from-gray-800/90 dark:via-gray-800/80 dark:to-gray-800/70 backdrop-blur-sm px-5 py-4 rounded-2xl shadow-sm hover:shadow-md dark:shadow-lg dark:border dark:border-gray-700/30">
                    <img 
                      src={dindinAvatar} 
                      alt="DINDIN AI" 
