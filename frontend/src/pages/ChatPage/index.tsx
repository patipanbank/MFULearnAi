            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 pb-32 space-y-4">
                    ...
                    <div
                      className={`max-w-xl w-fit px-4 py-3 rounded-2xl ${
                        msg.role === 'user'
                          ...
                          : 'bg-gradient-to-br from-white to-gray-50 dark:from-gray-800/90 dark:via-gray-800/80 dark:to-gray-800/70 backdrop-blur-sm text-black dark:text-white mr-4 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out border border-gray-100 dark:border-gray-700/30 dark:hover:border-gray-600/40'
                      }`}
                    >
                      {/* Images */}
              ...
              {isTyping && (
                <div className="flex justify-start max-w-3xl mx-auto">
                  <div className="flex items-center space-x-3 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800/90 dark:via-gray-800/80 dark:to-gray-800/70 backdrop-blur-sm px-5 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out border border-gray-100 dark:border-gray-700/30">
                    <img 
                      src={dindinAvatar} 
                      alt="DINDIN AI" 
                      className="w-7 h-7 rounded-full ring-2 ring-gray-200/50 dark:ring-gray-600/30"
                    />
                    <div className="flex space-x-2">
                      <div className="w-2.5 h-2.5 bg-blue-400/80 dark:bg-blue-400/80 rounded-full animate-bounce shadow-sm" />
                      <div className="w-2.5 h-2.5 bg-blue-400/80 dark:bg-blue-400/80 rounded-full animate-bounce shadow-sm" style={{ animationDelay: '0.2s' }} />
                      <div className="w-2.5 h-2.5 bg-blue-400/80 dark:bg-blue-400/80 rounded-full animate-bounce shadow-sm" style={{ animationDelay: '0.4s' }} />
                    </div>
                  </div>
                </div>
              )}
