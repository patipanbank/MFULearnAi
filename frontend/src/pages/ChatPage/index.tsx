  ...
  return (
    <div className="flex h-full bg-primary">
      ...
      <div className="flex-1 flex flex-col max-w-none">
        {/* Messages */}
        {hasMessages && (
        <div className="flex-1 overflow-y-auto px-4 md:px-16 lg:px-32 xl:px-64 2xl:px-96 py-4 pb-32 space-y-4">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary via-primary to-transparent pt-6">
          <div className="px-4 md:px-16 lg:px-32 xl:px-64 2xl:px-96 pb-6">
            <ResponsiveChatInput
              message={message}
