...
import { FaComments, FaBars, FaCog, FaSignOutAlt, FaPlus } from 'react-icons/fa';
      ...
      <div className="flex-1 px-4 py-2">
        <nav>
          <button
            ...
            className="w-full flex items-center px-4 py-2 mb-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
          >
