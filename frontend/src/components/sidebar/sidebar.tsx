...
import { FaComments, FaBars, FaSignOutAlt, FaTrash, FaEdit, FaAndroid, FaSearch, FaBookOpen, FaUserPlus, FaQuestionCircle, FaChartBar, FaCog, FaUsers, FaBuilding, FaMicrochip } from 'react-icons/fa';
          ...
          {isSuperAdmin && (
            <>
              ...
              <Link
                ...
                className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-200 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200
                  ${location.pathname === '/question-analysis' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : ''}`}
                onClick={onClose}
              >
                <FaMicrochip className="w-5 h-5 mr-3 flex-shrink-0" />
                <span className="font-medium truncate">Question Analysis</span>
              </Link>
