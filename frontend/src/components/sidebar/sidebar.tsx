    ...
    >
      ...
      <div className={`flex-none mt-auto border-t border-gray-200 dark:border-gray-700 pb-[env(safe-area-inset-bottom)] z-40 bg-white dark:bg-gray-800 transition-all duration-300 w-full`}>
        <div className="p-2 relative" data-settings-popup>
          ...
          {/* Settings popup */}
          {showSettingsPopup && (
            <div className="absolute bottom-full left-2 mb-2 w-72 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-600/50 z-50 overflow-hidden animate-pop-up origin-bottom-left" data-settings-popup>
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-600 mt-3 pt-3">
                    ...
                    >
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-all duration-200 ${isDarkMode
                        ? 'bg-gradient-to-br from-red-100 to-yellow-100 dark:from-red-900/30 dark:to-yellow-900/30'
