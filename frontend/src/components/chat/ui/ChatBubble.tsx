  ...
  return (
    <div className="message relative">
      {isEditing ? (
        ...
        >
          <div 
            className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-3xl max-h-[80vh] flex flex-col shadow-xl dark:shadow-2xl border border-gray-200 dark:border-gray-700"
          ...
          >
            ...
            <div className="p-4 flex-grow overflow-auto bg-white dark:bg-gray-800">
              <textarea
                value={editedContent}
            ...
            <div className="p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-750 rounded-b-lg flex justify-end gap-3">
              ...
              <button
                ...
                shadow-sm hover:shadow transition-all font-medium dark:bg-blue-600 dark:hover:bg-blue-700"
              >
                Save Changes
              </button>
            </div>
