...
export const ModelCard: React.FC<ModelCardProps> = ({ model, onClick, onRename, onDelete }) => {
                    ...
                    <div className="absolute top-4 right-4 hidden group-hover:flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 
                          rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors duration-200
                          disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Delete"
                      >
                        {isDeleting === model.id ? (
