  ...
  <div class="login-container">
    <div class="login-card fade-in">
      ...
      <div class="login-header">
        ...
        <p class="app-subtitle">AI Assistant powered by MFU</p>
        <span v-if="isTestEnv" class="env-badge">Staging Environment</span>
      </div>
      ...
      <div class="login-footer">
        <p class="pdpa-notice">
          ...
          <a href="#">Terms of Service</a> and <a href="#">PDPA Policy</a>.
        </p>
      </div>
    </div>
