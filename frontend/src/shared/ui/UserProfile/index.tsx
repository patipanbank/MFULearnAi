      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-[280px] bg-primary border border-border rounded-xl shadow-xl overflow-hidden"
          >
            {/* User Profile Header */}
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="p-3 bg-gradient-to-r from-[rgb(186,12,47)] to-[rgb(212,175,55)]"
            >
              <div className="flex items-center space-x-3">
                <motion.div
                  ...
                  className="h-12 w-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white text-xl font-semibold"
                >
                  {getInitials()}
                </motion.div>
                <motion.div
