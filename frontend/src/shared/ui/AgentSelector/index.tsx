  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center space-x-3 px-4 py-2 bg-secondary hover:bg-accent rounded-lg transition-colors duration-200 min-w-64"
      >
        ...
        <div className="flex items-center space-x-2">
          {isLoadingAgents && (
            <FiRefreshCw className="h-3 w-3 text-muted animate-spin" />
          )}
