...
const config: Config = {
  ...
  ACCESS_TOKEN_EXPIRE_MINUTES: parseInt(process.env.ACCESS_TOKEN_EXPIRE_MINUTES || '10080'),
  FRONTEND_URL: APP_ENV === 'development' ? process.env.DEV_FRONTEND_URL : process.env.PROD_FRONTEND_URL || process.env.FRONTEND_URL,
  ...
  APP_ENV,
  DEPARTMENT_SERVICE_URL: process.env.DEPARTMENT_SERVICE_URL || 'http://department-service:3001',
};
