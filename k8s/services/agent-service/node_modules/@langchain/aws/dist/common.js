import { AIMessage, AIMessageChunk, parseBase64DataUrl, parseMimeType, convertToProviderContentBlock, isDataContentBlock, } from "@langchain/core/messages";
...
export function langchainReasoningBlockToBedrockReasoningBlock(content) {
...
export function concatenateLangchainReasoningBlocks(content) {
...
export function supportedToolChoiceValuesForModel(model) {
