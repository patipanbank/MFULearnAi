...
router.post('/collections_add/:name', async (req, res) => {
...
router.post('/collections_query/:name', async (req, res) => {
...
router.get('/collections_documents/:name', async (req, res) => {
...
router.post('/collections_delete_documents/:name', async (req, res) => {
    const { ids } = req.body;
    try {
