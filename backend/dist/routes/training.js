...
async function processFileDocuments(file, user, modelId, collectionName) {
    ...
    const text = await document_1.documentService.processFile(file);
    console.log(`Text length (${text.length}) exceeds chunk size; splitting into chunks`);
    const chunks = (0, textUtils_1.splitTextIntoChunks)(text);
 ...
 */
router.post('/upload', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), upload.single('file'), async (req, res) => {
    try {
        const file = req.file;
        if (!file) {
 ...
 */
router.post('/documents', (0, roleGuard_1.roleGuard)(['Students', 'Staffs', 'Admin']), upload.single('file'), async (req, res) => {
    try {
        const { modelId, collectionName } = req.body;
        const user = req.user;
        // Ensure the collection exists (creates if needed)
        await chroma_1.chromaService.ensureCollectionExists(collectionName, user);
        const file = req.file;
        if (!file) {
            res.status(400).json({ error: 'No file uploaded' });
            return;
 ...
 */
router.get('/collections', (0, roleGuard_1.roleGuard)(['Students', 'Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.post('/collections', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.put('/collections/:id', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const canAccess = collection.permission === Collection_2.CollectionPermission.PUBLIC ||
            (collection.permission === Collection_2.CollectionPermission.STAFF_ONLY && user.groups.includes('Staffs')) ||
 ...
 */
router.delete('/collections/:id', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
        const { id } = req.params;
        const user = req.user;
 ...
 */
router.delete('/collections', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.get('/documents', (0, roleGuard_1.roleGuard)(['Students', 'Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.delete('/documents/:id', (0, roleGuard_1.roleGuard)(['Students', 'Staffs', 'Admin']), async (req, res) => {
    try {
        const { id } = req.params;
        const { collectionName } = req.query;
        const user = req.user;
 ...
 */
router.delete('/documents/all/:collectionName', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.post('/add-urls', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
 ...
 */
router.delete('/cleanup', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    try {
...
router.get('/example/:id', async (req, res) => {
    try {
        ...
        const canAccess = collection.permission === Collection_2.CollectionPermission.PUBLIC ||
            (collection.permission === Collection_2.CollectionPermission.STAFF_ONLY &&
                req.user.groups.includes('Staffs')) ||
            collection.createdBy === req.user.nameID;
        res.status(200).json({
            id: collection._id,
            canAccess,
        });
...
router.post('/collections/:id/upload', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.post('/collections/:id/process', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.post('/collections/:id/process-batch', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.post('/collections/:id/process-status', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.post('/collections/:id/documents/:docId/process', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.delete('/collections/:id/documents/:docId', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
router.post('/collections/:id/documents/:docId/process-status', (0, roleGuard_1.roleGuard)(['Staffs', 'Admin']), async (req, res) => {
    // ... existing code ...
});
/**
 * GET /history
