...
export declare class RateLimitPresets {
    ...
    static strictAuth(): (req: Request, res: Response, next: NextFunction) => void;
    static saml(): (req: Request, res: Response, next: NextFunction) => void;
    static monitoring(): (req: Request, res: Response, next: NextFunction) => void;
