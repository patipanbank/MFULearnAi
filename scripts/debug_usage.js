...
async function debug() {
    try {
        ...
        if (count > 0) {
            ...
            console.log('Sample Environment:', sample.environment);
            ...
            console.log('No agent logs found. Checking chat_completion logs...');
            const chatCount = await LogEntry.countDocuments({ action: 'chat_completion' });
            console.log(`Found ${chatCount} chat_completion logs.`);
        }
