...
exports.CONTEXT_PROMPTS = exports.getSystemPrompt = exports.MFULEARNAI_SYSTEM_PROMPT = exports.DINDINAI_SYSTEM_PROMPT = void 0;
// Production (DinDinAI) - Formal, compliant, safe
exports.DINDINAI_SYSTEM_PROMPT = `คุณคือ "DinDin AI" (ดินดิน เอไอ) ผู้ช่วยอัจฉริยะอย่างเป็นทางการของมหาวิทยาลัยแม่ฟ้าหลวง
...
exports.MFULEARNAI_SYSTEM_PROMPT = `You are "MFULearnAI", an experimental AI assistant for Mae Fah Luang University's testing environment.
...
const getSystemPrompt = (envType) => {
    return envType === 'PROD' ? exports.DINDINAI_SYSTEM_PROMPT : exports.MFULEARNAI_SYSTEM_PROMPT;
};
...
exports.default = {
    DINDINAI_SYSTEM_PROMPT: exports.DINDINAI_SYSTEM_PROMPT,
    MFULEARNAI_SYSTEM_PROMPT: exports.MFULEARNAI_SYSTEM_PROMPT,
    getSystemPrompt: exports.getSystemPrompt,
    CONTEXT_PROMPTS: exports.CONTEXT_PROMPTS
};
